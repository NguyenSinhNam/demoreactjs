        ...
        use: ExtractTextPlugin.extract({
          ...
          use: [
            { loader: 'css-loader' },
            {
              ...
              options: { siteFolder: path.join(__dirname, '../node_modules/semantic-ui-less/definitions') }
            }
          ]
        }),
...
// source config https://github.com/gadyonysh/semantic-ui-less-module-loader
